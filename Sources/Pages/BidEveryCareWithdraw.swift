...
struct BidEveryCareWithdraw: StaticPage {
    ...
    var description: String = "Discover the story behind Bid Every Care Withdraw, the Princeton Class of 2000 25th Reunion theme inspired by the anthem Old Nassau."
