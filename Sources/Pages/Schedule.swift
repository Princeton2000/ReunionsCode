...
struct Schedule: StaticPage {
    ...
    let dayBlurbs: [dayData] = [
        (5, "Come back and see what's changed! We'll have family activities and a chance for people to ease back into life on campus at our headquarters in Whitman College."),
        (6, "We will host breakfast, lunch, and family activities at headquarters, and we will offer a community service event at HQ in the afternoon. Move on over to Jadwin Gym for our Class Cocktail Reception (5:30-6:30 pm) and Class Dinner (6:30-8:30 pm). Then party down with The Fresh Kids of Bel-Air and DJ Jen Urban in the evening."),
        (7, "Join us for a special class brunch and our class photo, then show off your new jacket and flair in the P-rade!\nLook out for  Alumni Faculty Forums with panelists from the Class of 2000!"),
