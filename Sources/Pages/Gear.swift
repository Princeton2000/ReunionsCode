...
struct Gear: StaticPage {
	...
	func body(context: PublishingContext) -> [BlockElement] {
		Alert {
			Text(markdown: "The store is currently **closed** while we transition to a new infrastrucure ahead of Reunions. Browse though – yYou'll be able to buy all of this whe you get to campus and afterwards on our brand new store.").fontWeight(.semibold).horizontalAlignment(.center)
		}.role(.info)
		Section {
